...
constexpr Coordinate PLATFORM_SPEED = 0.1 * 0.35 * 0.3/3 * 1.1;                                                                                // скорость платформы
...
constexpr Coordinate BALL_SPEED = 0.02 * 0.6/3;
constexpr unsigned int FPS = 60;   
constexpr unsigned int UPDATES = FPS * 3;                                                           // скорость мяча
